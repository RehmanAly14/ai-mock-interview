        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="mt-6 flex space-x-4">
              ...
              <a href="https://www.linkedin.com/in/sherry-rehman-2a42aa355" className="text-gray-400 hover:text-indigo-400 transition-colors">
                <span className="sr-only">LinkedIn</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>
              <a href="https://github.com/RehmanAly14" className="text-gray-400 hover:text-indigo-400 transition-colors">
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex space-x-6">
              ...
              <Link href="/cookies" className="text-sm text-gray-400 hover:text-indigo-400 transition-colors">
                Cookies
              </Link>
            </div>
          </div>
